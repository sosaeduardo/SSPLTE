...
<head>
    ...
    <link href="http://127.0.0.1:8000/css/all-landing.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                                            <li><a href="/home">Secretario De Seguridad Publica</a></li>
                                    </ul>
            </div><!--/.nav-collapse -->
        </div>
    </div>
        ...
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    ...
                    <h3><a href="http://127.0.0.1:8000/index.php/register" class="btn btn-lg btn-success">Get Started!</a></h3>
                </div>
                <div class="col-lg-2">
                    <h5>Amazing admin template</h5>
                    <p>Based on adminlte bootstrap theme</p>
                    <img class="hidden-xs hidden-sm hidden-md" src="http://127.0.0.1:8000/img/arrow1.png">
                </div>
                <div class="col-lg-8">
                    <img class="img-responsive" src="http://127.0.0.1:8000/img/app-bg.png" alt="">
                </div>
                <div class="col-lg-2">
                    <br>
                    <img class="hidden-xs hidden-sm hidden-md" src="http://127.0.0.1:8000/img/arrow2.png">
    ...
    <div id="intro">
        <div class="container">
            <div class="row centered">
                ...
                <br>
                <div class="col-lg-4">
                    <img src="http://127.0.0.1:8000/img/intro01.png" alt="">
                    <h3>Community</h3>
                ...
                <div class="col-lg-4">
                    <img src="http://127.0.0.1:8000/img/intro02.png" alt="">
                    <h3>Schedule</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
                <div class="col-lg-4">
                    <img src="http://127.0.0.1:8000/img/intro03.png" alt="">
                    <h3>Monitoring</h3>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 centered">
                    <img class="centered" src="http://127.0.0.1:8000/img/mobile.png" alt="">
                </div>
                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="http://127.0.0.1:8000/img/item-01.png" alt="">
                            </div>
                            <div class="item">
                                <img src="http://127.0.0.1:8000/img/item-02.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="http://127.0.0.1:8000/js/smoothscroll.js"></script>
<script>
    $('.carousel').carousel({
        interval: 3500
    })
